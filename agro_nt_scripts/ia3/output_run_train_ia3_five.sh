...
Output directory: /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/intermediate_data/no_filtering/soy_1500up_0down_42_log2plus1/results/LR0.003_WD0.001_B8_GA8_W5_MSbalanced
...
ERROR conda.cli.main_run:execute(47): `conda run python /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/agro_nt_scripts/ia3/train_ia3_with_hyperparameters.py --model_name_or_path /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/dnabert/agro-nucleotide-transformer-1b --data_path /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/intermediate_data/no_filtering/soy_1500up_0down_42_log2plus1 --num_train_epochs 12 --learning_rate 0.003 --weight_decay 0.001 --per_device_train_batch_size 8 --per_device_eval_batch_size 8 --gradient_accumulation_steps 8 --warmup_steps 5 --target_modules ['esm.encoder.layer.38.attention.self.key/esm.encoder.layer.38.attention.self.value/esm.encoder.layer.39.attention.self.key/esm.encoder.layer.39.attention.self.value/esm.encoder.layer.38.output.dense/esm.encoder.layer.39.output.dense'] --feedforward_modules ['esm.encoder.layer.38.output.dense/esm.encoder.layer.39.output.dense'] --output_dir /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/intermediate_data/no_filtering/soy_1500up_0down_42_log2plus1/results/LR0.003_WD0.001_B8_GA8_W5_MSbalanced --overwrite_output_dir True` failed. (See above for error)
...
/var/spool/slurmd/job10657707/slurm_script: line 76: syntax error near unexpected token `done'
/var/spool/slurmd/job10657707/slurm_script: line 76: `done'
