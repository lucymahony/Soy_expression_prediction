...
outdir="${data_path}/results/LR${learning_rate}_WD${weight_decay}_B${batch_size}_GA${gradient_accumulation_steps}_W${warmup_steps}_MS${module_strategy}_E${num_train_epochs}"
