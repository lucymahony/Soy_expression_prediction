Running training for: LR=0.0003
WD=0.001
Batch=8
...
Output directory: /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/intermediate_data/no_filtering/soy_1500up_0down_42_log2plus1/results/LR0.0003_WD0.001_B8_GA8_W5_MSbalanced_E25
usage: train_ia3_with_hyperparameters.py [-h]
                                         [--model_name_or_path MODEL_NAME_OR_PATH]
                                         [--use_ia3 [USE_IA3]] [--no_use_ia3]
                                         [--data_path DATA_PATH] [--kmer KMER]
                                         ...
                                         [--hyperparameter_results_file HYPERPARAMETER_RESULTS_FILE]
train_ia3_with_hyperparameters.py: error: argument --num_train_epochs: invalid int value: 'num_train_epochs'

ERROR conda.cli.main_run:execute(47): `conda run python /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/agro_nt_scripts/ia3/train_ia3_with_hyperparameters.py --model_name_or_path /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/dnabert/agro-nucleotide-transformer-1b --data_path /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/intermediate_data/no_filtering/soy_1500up_0down_42_log2plus1 --num_train_epochs num_train_epochs --learning_rate 0.0003 --weight_decay 0.001 --per_device_train_batch_size 8 --per_device_eval_batch_size 8 --gradient_accumulation_steps 8 --warmup_steps 5 --target_modules ['esm.encoder.layer.38.attention.self.key','esm.encoder.layer.38.attention.self.value','esm.encoder.layer.39.attention.self.key','esm.encoder.layer.39.attention.self.value','esm.encoder.layer.38.output.dense','esm.encoder.layer.39.output.dense'] --feedforward_modules ['esm.encoder.layer.38.output.dense','esm.encoder.layer.39.output.dense'] --output_dir /ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/intermediate_data/no_filtering/soy_1500up_0down_42_log2plus1/results/LR0.0003_WD0.001_B8_GA8_W5_MSbalanced_E25 --overwrite_output_dir True` failed. (See above for error)
