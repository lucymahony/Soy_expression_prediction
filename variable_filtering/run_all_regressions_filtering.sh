...
OUTPUT_BASE="../intermediate_data/filtering_experiment/"
mkdir -p "$OUTPUT_BASE"

dataset_dirs=(
  ../intermediate_data/threshold__0.07_9.17_150up_5000down
  ../intermediate_data/nofilter__None_None_150up_5000down
  ../intermediate_data/cv__None_None_150up_5000down)
