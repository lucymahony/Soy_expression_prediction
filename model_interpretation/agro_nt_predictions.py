...
if __name__ == "__main__":
    ...
    predict(
        ...
        data_args=DataArguments(
            data_path="/ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/intermediate_data/insilico_mutants",  # should contain test.csv - mutated_sequences.csv
            kmer=6  
        ),
        training_args=TrainingArguments(
            output_dir="../intermediate_data/predictions_output",
            run_name="insilico_eval",
