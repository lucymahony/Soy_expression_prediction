...
def model_initialise_train_head(model_name):
...
if __name__ == "__main__":
    ...
    print(f"\nK-mer setting: {'Non-overlapping' if args.non_overlapping_kmers else 'Overlapping'}\n")
    ...
    if args.k_folds > 1:
        cross_validate(
            model_init_fn=lambda: model_initialise_train_head(args.model_name),
        ...
        model =model_initialise_train_head(args.model_name)
