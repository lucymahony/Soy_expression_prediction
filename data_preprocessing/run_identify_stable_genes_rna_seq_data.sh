...
output_file_path='/ei/projects/c/c3109f4b-0db1-43ec-8cb5-df48d8ea89d0/scratch/repos/Soy_expression_prediction/results/figs/'

source ~/.bashrc
mamba activate transformers_py310_3
python identify_stable_genes_rna_seq_data.py $input_file_path $output_file_path
