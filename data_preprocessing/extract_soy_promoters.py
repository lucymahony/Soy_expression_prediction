...
def write_fasta_file(sequences_dictionary, out_file_name, distance_upstream, distance_downstream):
    with open(out_file_name, "w") as file:
        for gid, seq in tqdm(sequences_dictionary.items()):
            SeqIO.write(SeqRecord(Seq(seq), id=f"{gid}_prom_up{distance_upstream}_down{distance_downstream}", description=""), file, "fasta")
...
def main():
    ...
    write_fasta_file(sequences, out_file_path, distance_upstream, distance_downstream)
